...
const IdeaOverallRating = ({overallRate, isDisabled}) => {
    ...
    return (
        ...
        >
            ...
            <RatingView practicalityRate={practicality} creativityRate={creativity} valuableRate={valuable} isDisabled={isDisabled}/>
        </View>
    )
}
